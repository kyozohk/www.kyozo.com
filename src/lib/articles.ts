...
// Map article IDs to their images
export const articleImages: Record<string, string> = {
  "sound-healing-symphony": "https://images.unsplash.com/photo-1511379938547-c1f69419868d?w=800&h=600&fit=crop",
  "living-journal": "https://images.unsplash.com/photo-1514320291840-2e0a9bf2a9ae?w=800&h=600&fit=crop",
};
