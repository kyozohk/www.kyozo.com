...
export const UnifiedAuthDialog: React.FC<UnifiedAuthDialogProps> = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[580px] !p-0 overflow-hidden !bg-[#f5f5f5] !rounded-[32px] !border-0 [&>button]:hidden">
            ...
            <>
              <div className="text-center mb-6">
                ...
                <p className="text-sm text-gray-600">
                  {isSignUp ? `Create your account for ${communityName}` : `Welcome back to ${communityName}`}
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full h-11 bg-[#D4C5DD] hover:bg-[#c4b5cd] text-[#6B4C7A] font-semibold rounded-full transition-all disabled:opacity-50 text-base mt-4"
                >
                  {loading ? (
                ...
                <div className="relative py-2">
                  ...
                  <div className="relative flex justify-center text-xs">
                    <span className="px-3 bg-[#f5f5f5] text-gray-500">Or</span>
                  </div>
                </div>
                ...
                <button
                  ...
                  className="w-full h-11 bg-white border-2 border-gray-300 hover:bg-gray-50 text-gray-700 font-semibold rounded-full transition-all flex items-center justify-center gap-2 text-base"
                >
