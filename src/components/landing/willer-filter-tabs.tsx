          ...
          <div className="relative size-[14px] md:size-[17.754px]">
            <div className="absolute inset-[-16.16%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 23.491 23.491">
                <path d={filterIcons.allPath1} stroke={activeFilter === "All" ? "#926b7f" : "#3A3630"} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.64" />
                <path d={filterIcons.allPath2} stroke={activeFilter === "All" ? "#926b7f" : "#3A3630"} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.64" />
                <path d={filterIcons.allPath3} stroke={activeFilter === "All" ? "#926b7f" : "#3A3630"} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.64" />
                <path d={filterIcons.allPath4} stroke={activeFilter === "All" ? "#926b7f" : "#3A3630"} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.64" />
              </svg>
            </div>
          </div>
        </div>
          ...
          <div className="h-[17px] md:h-[21.198px] w-[19px] md:w-[24px]">
            <div className="relative inset-[-1.23%_-1.15%_-1.3%_-1.15%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24.5517 21.7356">
                <path d={filterIcons.readPath1} fill={activeFilter === "Read" ? "#926b7f" : "#3A3630"} />
                <path d={filterIcons.readPath2} fill={activeFilter === "Read" ? "#926b7f" : "#3A3630"} />
                <path d={filterIcons.readPath3} fill={activeFilter === "Read" ? "#926b7f" : "#3A3630"} />
                <path d={filterIcons.readPath4} fill={activeFilter === "Read" ? "#926b7f" : "#3A3630"} />
                <path d={filterIcons.readPath5} fill={activeFilter === "Read" ? "#926b7f" : "#3A3630"} />
                <path d={filterIcons.readPath6} fill={activeFilter === "Read" ? "#926b7f" : "#3A3630"} />
                <path d={filterIcons.readPath7} fill={activeFilter === "Read" ? "#926b7f" : "#3A3630"} />
                <path d={filterIcons.readPath8} fill={activeFilter === "Read" ? "#926b7f" : "#3A3630"} />
              </svg>
            </div>
          </div>
        </div>
            ...
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 29 27">
              <g>
                <g>
                  ...
                  <path d={listenIconPaths.listenFill1} fill={activeFilter === "Listen" ? "#926b7f" : "#3A3630"} />
                ...
                <g>
                  ...
                  <path d={listenIconPaths.listenFill2} fill={activeFilter === "Listen" ? "#926b7f" : "#3A3630"} />
                ...
                <g>
                  ...
                  <path d={listenIconPaths.listenFill3} fill={activeFilter === "Listen" ? "#926b7f" : "#3A3630"} />
          ...
          <div className="h-[13px] md:h-[16.687px] w-[21px] md:w-[26px]">
            <div className="relative inset-[-1.36%_0]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 26 17.1406">
                <path d={filterIcons.watchPath1} fill={activeFilter === "Watch" ? "#926b7f" : "#3A3630"} />
                <path d={filterIcons.watchPath2} fill={activeFilter === "Watch" ? "#926b7f" : "#3A3630"} />
              </svg>
            </div>
          </div>
        </div>
