    ...
    <>
      ...
      <aside className="sticky left-0 top-[10px] h-[calc(100vh-20px)] w-[80px] bg-white rounded-[24px] z-40 flex flex-col items-center p-[2px] border-2 border-[#e8dfd0] shrink-0 ml-[10px]">
        ...
        >
          <div className="h-[36.69px] w-[31.448px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 31.4483 36.6896">
              <path d={svgPaths.p1b92c200} fill="#3F3F3F" />
            </svg>
          </div>
        </button>
        ...
        <div className="flex flex-col items-center gap-[8px] py-[8px]">
          ...
          >
            <p className="font-bold leading-[16px] text-[#4f4949] text-[12px] text-center tracking-[-0.5px]">Willer</p>
            <p className="font-bold leading-[16px] text-[#4f4949] text-[12px] text-center whitespace-pre-wrap tracking-[-0.5px]">Universe</p>
          </Link>
        </div>
        ...
        <div className="flex-1 w-full flex flex-col items-center gap-[8px] pt-[10px]">
          ...
          <div className="flex flex-col gap-[12px] items-center">
            ...
            <Link
              ...
              className={`flex flex-col h-[62px] items-center justify-center rounded-[10px] w-[56px] transition-colors ${
                location.pathname === "/bio" ? "bg-[#e8dfd0]" : "hover:bg-[#f5f1e8]"
              }`}
            >
                  ...
                  <div className="flex flex-col gap-[1.067px] items-center justify-center px-[0.853px] py-[2.347px] size-full">
                    <div className="h-[5.813px] w-[20.693px]">
                      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20.6933 5.81334">
                        <path d={svgPaths.p3ac88f00} fill="#3A3630" />
                        <path d={svgPaths.p3db55400} fill="#3A3630" />
                      </svg>
                    </div>
                    <div className="h-[4.053px] w-[18.862px]">
                      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.2889 4.48">
                        <path d={svgPaths.p34fb9080} fill="#3A3630" />
                        <path d={svgPaths.p29813280} fill="#3A3630" />
                        <path d={svgPaths.p13f2d100} fill="#3A3630" />
                      </svg>
                    </div>
                    <div className="h-[5.813px] w-[20.693px]">
                      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20.6933 5.81334">
              ...
              <p className="font-semibold leading-[16px] text-[11px] text-[rgba(79,73,73,0.9)] text-center tracking-[-0.5px]">About</p>
            </Link>
            ...
            <Link
              ...
              className={`flex flex-col gap-[2px] h-[62px] items-center justify-center rounded-[10px] w-[56px] transition-colors ${
                location.pathname === "/feed" ? "bg-[#e8dfd0]" : "hover:bg-[#f5f1e8]"
              }`}
            >
              <div className="rotate-180">
                <div className="relative size-[32px]">
                  <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
                    <path d={svgPaths.pb1b74f0} fill="#4F4949" />
                    <path d={svgPaths.p1310b200} stroke="#4F4949" strokeWidth="0.5" />
                  </svg>
                </div>
              </div>
              <p className="font-semibold leading-[16px] text-[11px] text-[rgba(79,73,73,0.9)] text-center tracking-[-0.5px]">Feed</p>
            </Link>
            ...
            {/* <Link
              to="/community"
              className={`flex flex-col gap-[2px] h-[62px] items-center justify-center rounded-[10px] w-[56px] transition-colors ${
                location.pathname === "/community" ? "bg-[#e8dfd0]" : "hover:bg-[#f5f1e8]"
              }`}
            >
              <div className="relative shrink-0 size-[30.916px]">
                <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 30.9157 30.9157">
                  <path d={svgPaths.p34d77080} fill="#3A3630" stroke="#3A3630" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.21739" />
                  <path d={svgPaths.p3f012300} stroke="#3A3630" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.21739" />
                  <path d={svgPaths.p28826c40} stroke="#3A3630" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.21739" />
                </svg>
              </div>
              <p className="font-semibold leading-[16px] text-[11px] text-[rgba(79,73,73,0.9)] text-center tracking-[-0.5px]">Community</p>
            </Link> */}
          </div>
          ...
          <div className="flex flex-col gap-[12px] items-center">
            ...
            >
              ...
              <p className="font-semibold leading-[16px] text-[11px] text-[rgba(79,73,73,0.9)] text-center tracking-[-0.5px]">Sign In</p>
            </button>
            ...
            {/* <Link
              to="/explore"
              className={`flex flex-col gap-[2px] h-[62px] items-center justify-center rounded-[10px] w-[56px] transition-colors ${
                location.pathname === "/explore" ? "bg-[#e8dfd0]" : "hover:bg-[#f5f1e8]"
              }`}
            >
              <div className="relative shrink-0 size-[32px]">
                <svg className="block size-full" fill="none" viewBox="0 0 32 32">
              ...
              <p className="font-semibold leading-[16px] text-[11px] text-[rgba(79,73,73,0.9)] text-center tracking-[-0.5px]">Explore</p>
            </Link> */}
          </div>
        </div>
        ...
        <Link
          ...
          className={`flex flex-col gap-[2px] h-[62px] items-center justify-center rounded-[10px] w-[56px] transition-colors mb-[10px] ${
            location.pathname === "/modal" ? "bg-[#e8dfd0]" : "hover:bg-[#f5f1e8]"
          }`}
        >
          <div className="relative shrink-0 size-[40px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 318.746 264.195">
              <g>
                <path d={modalSvgPaths.p2691ca00} fill="#E9D3B3" stroke="#3A3630" strokeWidth="15" />
                <path d={modalSvgPaths.p31747500} fill="#E9D3B3" stroke="#3A3630" strokeWidth="15" />
                <path d={modalSvgPaths.p3f19bb00} fill="#E9D3B3" stroke="#3A3630" strokeWidth="15" />
                <path d={modalSvgPaths.p8032400} fill="#F2ECE3" stroke="#3A3630" strokeWidth="15" />
                <path d={modalSvgPaths.p1c380780} fill="#F2ECE3" stroke="#3A3630" strokeWidth="15" />
                <path d={modalSvgPaths.p369c1080} fill="#F2ECE3" stroke="#3A3630" strokeWidth="15" />
              </g>
            </svg>
          </div>
          <p className="font-semibold leading-[16px] text-[12px] text-[rgba(79,73,73,0.9)] text-center tracking-[-0.5px]">Modal</p>
        </Link>
      </aside>
    </>
  );
