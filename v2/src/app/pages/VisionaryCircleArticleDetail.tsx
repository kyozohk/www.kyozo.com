...
export function VisionaryCircleArticleDetail() {
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen bg-[#7a7a7a]">
      {/* Left Panel - Article Content */}
      <div className="flex-1 overflow-y-auto bg-gradient-to-br from-[#4a4a4a] to-[#3a3a3a] px-6 md:px-12 py-8 md:py-16">
        <div className="max-w-3xl mx-auto">
          <Link 
            to="/visionary-circle" 
            className="inline-flex items-center gap-2 text-[#9b8ea5] hover:text-[#b0a9b5] transition-colors mb-8 text-sm font-medium"
          >
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#e0e0e0] mb-8 leading-tight tracking-tight">
            {article.title}
          </h1>
          ...
          <div className="prose prose-lg prose-invert max-w-none">
            <p className="text-lg md:text-xl text-[#d0d0d0] leading-relaxed mb-6 font-light">
              {article.content}
            </p>

            <div className="mt-12 pt-8 border-t border-[#5a5a5a]">
              <h2 className="text-2xl md:text-3xl font-bold text-[#e0e0e0] mb-6">Key Insights</h2>
              
              <div className="space-y-6 text-[#c0c0c0]">
                <div className="bg-[#3a3a3a] rounded-xl p-6 border border-[#5a5a5a]">
                  <h3 className="text-xl font-bold text-[#9b8ea5] mb-3">Market Opportunity</h3>
                ...
                <div className="bg-[#3a3a3a] rounded-xl p-6 border border-[#5a5a5a]">
                  <h3 className="text-xl font-bold text-[#9b8ea5] mb-3">Strategic Positioning</h3>
                  <p className="leading-relaxed">
                ...
                <div className="bg-[#3a3a3a] rounded-xl p-6 border border-[#5a5a5a]">
                  <h3 className="text-xl font-bold text-[#9b8ea5] mb-3">Future Outlook</h3>
                  <p className="leading-relaxed">
